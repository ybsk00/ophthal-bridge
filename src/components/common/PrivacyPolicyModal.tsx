...
평촌이생각치과(이하 "병원")은 「개인정보 보호법」, 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 등 관련 법령이 정한 개인정보 보호 규정을 준수하며, 이용자의 권익 보호를 위해 본 개인정보 처리방침을 수립·공개합니다.
...
본 약관은 평촌이생각치과(이하 "병원")이 제공하는 웹/앱 서비스의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.
